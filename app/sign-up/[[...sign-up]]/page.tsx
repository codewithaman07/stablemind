    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'var(--bg-primary)' }}>
      <div className="max-w-md w-full space-y-8 p-8 rounded-2xl border" style={{ background: 'var(--bg-secondary)', borderColor: 'var(--border-primary)' }}>
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold mb-2" style={{ color: 'var(--text-primary)' }}>Join StableMind</h2>
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Create your account to start your mental wellness journey</p>
        </div>
