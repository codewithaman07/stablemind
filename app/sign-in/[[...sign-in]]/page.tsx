    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-purple-50 dark:from-gray-900 dark:to-indigo-900">
      <div className="max-w-md w-full space-y-8 p-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Welcome Back to StableMind</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-8">Sign in to continue your mental wellness journey</p>
        </div>
